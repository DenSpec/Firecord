...
/* Fonctionnalités de scroll automatique, avec un simple behavior */
...
/* Fonction de sendMessage qui va dans la collection messages, en passant par les Id grâce à Redux.
   Comme d'habitude, on passe par un inputRef.
*/
  const sendMessage = (e) => {
    e.preventDefault();
